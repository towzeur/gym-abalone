...
class Marble:
    ...
    DEBUG_STYLE = {"font_name": "Arial", "font_size": 24, "anchor_x": "center", "anchor_y": "center"}

    LABEL_COLORS = {"default": (0, 0, 0, 255), 0: (0, 0, 0, 255), 1: (255, 255, 255, 255)}
    ...
    def __init__(self, player, theme, batch, groups, debug=False):
        ...
        self.sprites = {sprite_name: None for sprite_name in ["marble", "label", "arrow", "selected"]}
        self._init_sprites()
    ...
    def _init_sprites(self):
        ...
        if self.debug:
            ...
            self.sprites["label"] = pyglet.text.Label(
                color=color, batch=self.batch, group=self.groups[2], **Marble.DEBUG_STYLE
            )
